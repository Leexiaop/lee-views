(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["lee-views"] = factory();
	else
		root["lee-views"] = factory();
...
// load the styles
var content = __webpack_require__("28e8");
if(typeof content === 'string') content = [[module.i, content, '']];
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var add = __webpack_require__("499e").default
var update = add("b8be85e4", content, true, {"sourceMap":false,"shadowMode":false});
...
// Module
exports.push([module.i, ".lee-steps[data-v-bf7c95a6]{width:100%;padding:0;margin:0}.lee-steps-row[data-v-bf7c95a6]{display:flex;flex-direction:row;justify-content:space-between;align-items:baseline}.lee-steps-row li[data-v-bf7c95a6]{width:100%;list-style:none}.lee-steps-row .lee-steps-content-title[data-v-bf7c95a6]{width:100%;display:flex;align-items:center}.lee-steps-row .lee-steps-content-title span[data-v-bf7c95a6]{display:block;width:32px;height:32px;line-height:32px;text-align:center;border-radius:50%;border:1px solid #333}.lee-steps-row .lee-steps-content-title i[data-v-bf7c95a6]{display:block;width:calc(100% - 48px);padding:0 16px}.lee-steps-colum[data-v-bf7c95a6]{height:100%;display:flex;flex-direction:column;justify-content:center;align-items:baseline}.lee-steps-colum li[data-v-bf7c95a6]{height:100%;list-style:none;display:flex}.lee-steps-colum li .lee-steps-content-title[data-v-bf7c95a6]{display:flex;flex-direction:column;align-items:center}.lee-steps-colum li .lee-steps-content-title span[data-v-bf7c95a6]{display:block;width:32px;height:32px;line-height:32px;text-align:center;border-radius:50%;border:1px solid #333}.lee-steps-colum li .lee-steps-content-title i[data-v-bf7c95a6]{display:block;height:calc(100% - 48px);padding:16px 0}", ""]);
// Exports
...
"use strict";
/* harmony import */ var _node_modules_vue_style_loader_index_js_ref_10_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_10_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_10_oneOf_1_2_node_modules_postcss_loader_src_index_js_ref_10_oneOf_1_3_node_modules_less_loader_dist_cjs_js_ref_10_oneOf_1_4_node_modules_cache_loader_dist_cjs_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_steps_vue_vue_type_style_index_0_id_bf7c95a6_lang_less_scoped_true___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__("0ecd");
/* harmony import */ var _node_modules_vue_style_loader_index_js_ref_10_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_10_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_10_oneOf_1_2_node_modules_postcss_loader_src_index_js_ref_10_oneOf_1_3_node_modules_less_loader_dist_cjs_js_ref_10_oneOf_1_4_node_modules_cache_loader_dist_cjs_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_steps_vue_vue_type_style_index_0_id_bf7c95a6_lang_less_scoped_true___WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_node_modules_vue_style_loader_index_js_ref_10_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_10_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_10_oneOf_1_2_node_modules_postcss_loader_src_index_js_ref_10_oneOf_1_3_node_modules_less_loader_dist_cjs_js_ref_10_oneOf_1_4_node_modules_cache_loader_dist_cjs_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_steps_vue_vue_type_style_index_0_id_bf7c95a6_lang_less_scoped_true___WEBPACK_IMPORTED_MODULE_0__);
/* unused harmony reexport * */
 /* unused harmony default export */ var _unused_webpack_default_export = (_node_modules_vue_style_loader_index_js_ref_10_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_10_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_10_oneOf_1_2_node_modules_postcss_loader_src_index_js_ref_10_oneOf_1_3_node_modules_less_loader_dist_cjs_js_ref_10_oneOf_1_4_node_modules_cache_loader_dist_cjs_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_steps_vue_vue_type_style_index_0_id_bf7c95a6_lang_less_scoped_true___WEBPACK_IMPORTED_MODULE_0___default.a); 
...
// CONCATENATED MODULE: ./node_modules/cache-loader/dist/cjs.js?{"cacheDirectory":"node_modules/.cache/vue-loader","cacheIdentifier":"4aaea27a-vue-loader-template"}!./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/cache-loader/dist/cjs.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./packages/leeSteps/src/steps.vue?vue&type=template&id=bf7c95a6&scoped=true&
var stepsvue_type_template_id_bf7c95a6_scoped_true_render = function () {
var _obj;
var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('ul',{staticClass:"lee-steps",class:( _obj = {}, _obj[("lee-steps-" + _vm.vertical)] = true, _obj )},_vm._l((_vm.list),function(item,index){return _c('li',{key:index,staticClass:"lee-steps-content",style:({color: _vm.active >= index ? _vm.activeColor : 'lightgry'})},[_c('div',{staticClass:"lee-steps-content-title"},[(_vm.$slots.icon)?_c('div',[_vm._t("icon")],2):_c('span',{style:({
                border: _vm.active >= index ? ("1px solid " + _vm.activeColor) : '1px solid #333',
                color: _vm.active >= index ? _vm.activeColor : '#333'
            })},[_vm._v(_vm._s(index + 1))]),(index < _vm.list.length - 1)?_c('i',{style:({
                border: _vm.active >= index ? ("1px solid " + _vm.activeColor) : '1px solid #333'
            })}):_vm._e()]),_c('div',{staticClass:"lee-steps-content-content"},[_c('div',[_vm._v(_vm._s(item.title))]),_c('div',[_vm._v(_vm._s(item.description))])])])}),0)}
var stepsvue_type_template_id_bf7c95a6_scoped_true_staticRenderFns = []


// CONCATENATED MODULE: ./packages/leeSteps/src/steps.vue?vue&type=template&id=bf7c95a6&scoped=true&
...
// EXTERNAL MODULE: ./packages/leeSteps/src/steps.vue?vue&type=style&index=0&id=bf7c95a6&lang=less&scoped=true&
var stepsvue_type_style_index_0_id_bf7c95a6_lang_less_scoped_true_ = __webpack_require__("919e");
...
var steps_component = normalizeComponent(
  ...
  stepsvue_type_template_id_bf7c95a6_scoped_true_render,
  stepsvue_type_template_id_bf7c95a6_scoped_true_staticRenderFns,
  false,
  null,
  "bf7c95a6",
  null
...
//# sourceMappingURL=lee-views.umd.js.map